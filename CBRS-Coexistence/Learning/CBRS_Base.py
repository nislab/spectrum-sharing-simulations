...
# customer statistics
LAMc = 0.5 # Arrival rate 
MUc = 1 # Service rate = 1/(first moment of service)
RHOc = LAMc/MUc # traffic load, used for validation
Kc = 1  # Service Distribution; defined such that second moment of service = K/MU^2

# incumbent statistics
LAMi = 0.3 # Arrival rate 
MUi = 1 # Service rate = 1/(first moment of service)
...
C = 0.833333 # Cost to join Premium class
...
def main():
	PHI = 0.495 # Round 1, customers proceed with initial belief PHI without option to deviate
	...
	for i in range(ITERATIONS):
		...
		#mean_wait_i = w[0]/n[0] # mean_wait of incumbents
		mean_wait_i = 0
