"""
Wrapper to define values for MM1_Two_Class_Switchover_Sim Simulator, define save files for statistics
Author: Jonathan Chamberlain, 2021 jdchambo@bu.edu
"""

from MM1_Two_Class_Switchover_Sim import Simulator
import os
